...
class EntertainPage extends StatefulWidget {
  EntertainPage({Key? key}) : super(key: key);

  @override
  State<EntertainPage> createState() => _EntertainPageState();
}

class _EntertainPageState extends State<EntertainPage> {
  @override
...
class EntertainList extends StatefulWidget {
  EntertainList({Key? key}) : super(key: key);
  @override
  State<EntertainList> createState() => _EntertainListState();
}

class _EntertainListState extends State<EntertainList> {
  ...
  void getdata() {
    Future<Uint8List> back = NetUtils.getJsonBytes(
        'http://1.117.239.54:8080/task?operation=getByTag&index='+Account.account+'&key=3');
    back.then((value) {
